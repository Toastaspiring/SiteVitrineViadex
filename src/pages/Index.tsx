      ...
      <main className="pt-16">
        ...
        <section className="relative overflow-hidden px-6 lg:px-8 py-24 sm:py-32 bg-gradient-to-r from-blue-700 to-blue-500 text-white">
          <div className="mx-auto max-w-7xl relative">
            ...
            <div className="absolute right-0 top-1/2 transform -translate-y-1/2 opacity-90 md:opacity-100 pointer-events-none z-0 hidden md:block lg:block max-md:hidden">
