...
const FormationBanner = () => {
  return <section className="py-12 px-6 lg:px-8 bg-gradient-to-r from-blue-100 to-blue-50">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-8 rounded-xl shadow-sm">
          <div className="md:w-7/12">
            ...
            <p className="text-secondary mb-6">Maîtrisez l'IA Générative avec discernement grâce à la certification CertifOpac, reconnue officiellement en partenariat avec JustAI. Formation éligible CPF pour les professionnels souhaitant intégrer l'IA de façon concrète et responsable.</p>
            <Link to="/formation">
